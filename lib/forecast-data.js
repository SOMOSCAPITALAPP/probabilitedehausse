...
const FORECASTS_RESULT_CACHE_TTL_MS = 60 * 1000;
...
export async function getForecasts() {
  return withMemoryCache("forecasts:resolved", FORECASTS_RESULT_CACHE_TTL_MS, async () => {
    let diagnostics = [];
...
export async function getReferenceBenchmarkPayload(asset) {
  ...
  for (const candidate of candidates) {
    const historyRows = allHistories.get(candidate.benchmarkCode) || [];
