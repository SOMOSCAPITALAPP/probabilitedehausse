...
function getAssetBenchmarkCandidates(asset) {
  ...
  if (symbol.endsWith(".PA")) {
    return [
      { benchmarkCode: "FR40", benchmarkName: "CAC 40" },
      { benchmarkCode: "SX5E", benchmarkName: "Euro Stoxx 50" },
    ];
  }
  if (symbol.endsWith(".DE")) {
    return [
      { benchmarkCode: "DE40", benchmarkName: "DAX 40" },
      { benchmarkCode: "SX5E", benchmarkName: "Euro Stoxx 50" },
    ];
  }
  if (symbol.endsWith(".AS")) {
    return [
      { benchmarkCode: "NL25", benchmarkName: "AEX 25" },
      { benchmarkCode: "SX5E", benchmarkName: "Euro Stoxx 50" },
    ];
  }
  if (symbol.endsWith(".MI")) {
    return [
      { benchmarkCode: "IT40", benchmarkName: "FTSE MIB" },
      { benchmarkCode: "SX5E", benchmarkName: "Euro Stoxx 50" },
    ];
  }
  if (symbol.endsWith(".MC")) {
    return [
      { benchmarkCode: "ES35", benchmarkName: "IBEX 35" },
      { benchmarkCode: "SX5E", benchmarkName: "Euro Stoxx 50" },
    ];
  }
  if (symbol.endsWith(".SW")) {
    return [
      { benchmarkCode: "CH20", benchmarkName: "SMI 20" },
      { benchmarkCode: "SX5E", benchmarkName: "Euro Stoxx 50" },
    ];
  }
